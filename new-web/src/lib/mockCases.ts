  ...
  "tok_sarah_abc123": {
    ...
    explanation: {
      en: {
        ...
        paragraph1: "",
        paragraph2: "Your care team recommended follow-up imaging to understand this finding and plan next steps.",
        ...
        steps: [
          ...
          { label: "Follow-up scan booked", detail: "July 28", done: true },
      ...
      "ar-TN": {
        ...
        paragraph1: "",
        paragraph2: "أوصى فريق رعايتك بفحص متابعة لفهم هذه النتيجة والتخطيط للخطوات التالية.",
        paragraph3: "الكشف المبكر يعطي أفضل النتائج — لهذا اتصلنا بك.",
        steps: [
          { label: "طبيبك راجع فحصك", detail: "اليوم", done: true },
          { label: "اتصلنا بك لنشرح", detail: "اليوم", done: true },
          { label: "تم حجز فحص المتابعة", detail: "28 يوليو", done: true },
      ...
      fr: {
        ...
        paragraph1: "",
        paragraph2: "Votre équipe soignante a recommandé un examen de suivi pour mieux comprendre ce résultat et planifier la suite.",
        paragraph3: "Détecter les choses tôt donne les meilleurs résultats — c'est pourquoi nous avons appelé.",
        steps: [
          { label: "Votre médecin a examiné votre scanner", detail: "aujourd'hui", done: true },
          { label: "Nous vous avons appelé pour expliquer", detail: "aujourd'hui", done: true },
          { label: "Scanner de suivi réservé", detail: "28 juillet", done: true },
      ...
      zh: {
        ...
        paragraph1: "",
        paragraph2: "您的医疗团队建议进行随访成像，以便了解这一发现并规划后续步骤。",
        paragraph3: "早期发现能带来最佳结果——这就是我们致电的原因。",
        steps: [
          { label: "您的医生已审查您的扫描", detail: "今天", done: true },
          { label: "我们致电为您解释", detail: "今天", done: true },
          { label: "已预约随访扫描", detail: "7月28日", done: true },
