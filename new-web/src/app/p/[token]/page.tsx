...
export default function PatientPortalPage({
  ...
  return (
    ...
    >
      ...
      <main
        id="main-content"
        className="mx-auto max-w-5xl px-4 pt-5 pb-28 lg:py-10 lg:px-8"
      >
        {/* Desktop hero */}
        ...
        {view.urgency !== "NO_FU" && (
          ...
          >
            <div
              ...
              style={{
                background: `color-mix(in oklch, ${URGENCY_FG[view.urgency]} 15%, transparent)`,
                color: URGENCY_FG[view.urgency],
              }}
            >
            ...
            <div className="flex-1 min-w-0">
              <p
                ...
                style={{ color: URGENCY_FG[view.urgency] }}
              >
                {URGENCY_MSG[view.urgency]?.[locale] ?? URGENCY_MSG[view.urgency]?.["en"]}
              </p>
              <p
                className="text-sm mt-0.5"
                style={{ color: URGENCY_FG[view.urgency], opacity: 0.75 }}
              >
